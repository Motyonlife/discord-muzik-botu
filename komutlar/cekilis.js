            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " (XQ çekiliş sistemi)", message.author.avatarURL);
            ...
            .setFooter("(XQ çekiliş sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü Yetkilileri Etiketleyerek Alabilirsin!").setFooter("(XQ çekiliş sistemi)")
