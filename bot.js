...
.then(channel =>
            ...
            message.guild.createChannel('Yapımcım: Tekne#0691', 'voice', [{
              id: message.guild.id,
              deny: ['CONNECT']
            }])
            .then(channel =>
...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle(' XQ Müzik | Şarkı Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('RANDOM'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('RANDOM')
     .setTitle(' XQ Music | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("** XQ Music | 🎙 Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
...
//rolemo
const yourID = "674212659968606208"; //Instructions on how to get this: https://redd.it/40zgse //Kendi İD'nizi Yazın
const setupCMD = "!lol" //İstediğiniz Komut Yapabilirsiniz örn : !kayıtol
let initialMessage = ``; //Dilediğiniz Şeyi Yazabilirsiniz
const roles = ["๖League of legends Oyuncusu"]; //İstediğiniz Rolü Yazabilirsiniz
const reactions = ["654386891524800540"]; //İstediğiniz Emojiyi Ekleyebilirsiniz
